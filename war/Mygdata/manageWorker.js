...
console.debug("Inside manageWorker in Mygdata::");
...
worker.addEventListener('message', function(e) {
	  ...
	  console.debug("Checking who sent reponse to manageWorkers::"+e.target);
...
function generateTable(data,range){
	console.debug("Inside manageWorker generateTable Mygdata::");
