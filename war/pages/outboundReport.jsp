...
<script>
 ...
 $j(document).ready(function(){
	console.log("Inside outboundReport.jsp script");
 ...
 function validateEmail(email) { 
	  console.log("Inside validateEmail in outboundReport.jsp script");
	    var re = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
	    return re.test(email);
	} 
 function validateFormData()
 {  console.log("Inside validateFormData in outboundReport.jsp script");
 ...
 {  console.log("Inside fetchOutboundData in outboundReport.jsp script");
	 processGARequest($j('#dataFilter').serialize(),'http://gabackend.gadataservice-new-s.appspot.com/fetchV2Outbound.do?');
 }
...
<div  id="msg"class="alert" >
    ...
    <tr>
    <td>
    	<form id="dataFilter"  action='http://gabackend.gadataservice-new-s.appspot.com/fetchV2Outbound.do'>
