...
console.debug("Inside respond js in war");
...
{   //console.debug("Inside manageWorker w filterData w::");
	console.log("filter");
...
{  // console.debug("Inside manageWorker setCallFilter w::");
	clearData();
...
function generateTable(data,range){
	console.debug("Inside manageWorker generateTable w::");
	var columnName=[];
