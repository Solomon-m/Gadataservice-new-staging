...
console.debug("Inside reportProcessor war");
function navigate(page,id)
{ 
	console.debug("Inside reportProcessor navigate w::");
	if(page=="Call Action")
...
function setPageSize(value,tabName) {
	console.debug("Inside reportProcessor setPageSize w::");
    if (value) {
...
{	
	console.debug("Inside reportProcessor processGAData w::");
...
{	
	console.debug("Inside reportProcessor getEventDescriptionForCategory w::");
	var rowObj;
	var uniqueDimension;
	var filteredData;
...
{var i,j=0;
   console.debug("Inside reportProcessor filterDataByDimension w::");
...
{//console.log(index);
	console.debug("Inside reportProcessor getUniqueDimensionFromGAData w::");
	var i,
    len=rowArray.length,
    out=[],
    obj={};
...
function isObjNull(obj)
{
  ...
  {
	 console.debug("Inside reportProcessor getCallDetails w::");
  ...
  {   
	 console.debug("Inside reportProcessor createCallerMap w::");
  ...
  {		console.debug("Inside reportProcessor getCallerAccountDetails w::");	
	  createCallerMap(3);
	  var callerAccount=[];
  ...
  {   console.debug("Inside reportProcessor filterDimension w:: ");
  ...
  {
	  console.debug(" Inside reportProcessor filterData w::");
     ...
     //console.debug("Inside reportProcessor filterData w:: rData is ::"+rData)
  ...
  { 
	  console.debug("Inside reportProcessor filterEventData w::");
	  var dimension=document.getElementById("dimension").value;
	  var filterData=document.getElementById("filterData").value;
...
console.log(index);	  dataset=getUniqueDimensionFromGAData(jsonData,index);
  ...
  {var callerAccount=[];
     console.debug("Inside reportProcessor filterCallDataMap w::");
  ...
  {
	   console.debug("Inside reportProcessor formatTimeStamp w::");
  ...
  {   console.debug("Inside reportProcessor groupDataByDimension w::");
  ...
  {   console.debug("Inside reportProcessor callActionHandler w::");
  ...
  function pivotDataByDimension() {
	  console.debug("Inside reportProcessor pivotDataByDimension w::");
	  var options = {'showRowNumber': true};
  ...
  {   console.debug("Inside reportProcessor DownloadJSON2CSV w::");
 	...
 	function agentActionSummary()
 	  { 
 		console.debug("Inside reportProcessor agentActionSummary w::");
...
// 		}
 	...
 	{
 		console.debug("Inside reportProcessor drawAgentDetail w::");
//  		columnData=agentActionSummary();
  ...
  table.draw(dataView1, options);
 	...
 	{   console.debug("Inside reportProcessor getAccountLoadColumns w::");
 		var index= new Array();
 		for(c in columnData)
 			{
 	...
 	{   console.debug("Inside reportProcessor getCXFeedbackReport w:: ");
 	...
 	{	 console.debug("Inside reportProcessor createAgentDetailsCSVReport w::");
 		csvData= null;
 	...
 	{   console.debug("Inside reportProcessor renameAction w::");
...
{   console.debug("Inside reportProcessor CallConclusionReport w::");
...
function drawCCDetail()
	{
		console.debug("Inside reportProcessor drawCCDetail w::");
