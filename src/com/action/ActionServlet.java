...
public class ActionServlet {
	...
	final static String CLIENT_ID = "314873777255-7nbr179pmmdo76c8590t09vhplo9m6cr.apps.googleusercontent.com";
	/** The Constant CLIENT_SECRET. */	
	final static String CLIENT_SECRET ="diSGDdZv9ITyjIoBA8BB9998";
	/** The Constant REDIRECT_URL. */	
	final static String REDIRECT_URL ="http://www.gadataservice-new-s.appspot.com/oauth2callback.do";
	/** The Constant SCOPE. */ 
	...
	{ 
		...
		//This code came in logs on 20 aug morning at first hit.
		//String code ="4/sIcB9fBE3ryN3_vsEKvWh5mhvdeI.Mj7TFa-bpLEdcp7tdiljKKaBq9fdjwI";
	...
	{	System.out.println("Checking getAuthCode:: in ActionServlet");
		String redirectUri="http://www.gadataservice-new-s.appspot.com/oauth2callback.do";
	 ...
	 try
		...
		// String redirectString="https://accounts.google.com/o/oauth2/auth?client_id="+"171068777204-uh3o3umebclqgdvd030ojm939l4rf3mr.apps.googleusercontent.com"+"&redirect_uri="+redirectUri+"&response_type=code&scope=https://www.googleapis.com/auth/analytics.readonly&access_type=offline&approval_prompt=force&state="+gaFilter;
		 String redirectString="https://accounts.google.com/o/oauth2/auth?client_id="+"314873777255-7nbr179pmmdo76c8590t09vhplo9m6cr.apps.googleusercontent.com"+"&redirect_uri="+redirectUri+"&response_type=code&scope=https://www.googleapis.com/auth/analytics.readonly&access_type=offline&approval_prompt=force&state="+gaFilter;
	...
	System.out.println("inside getGASecvice");
    	...
    	try {
    			...
    			String redirectUri="http://www.gadataservice-new-s.appspot.com/oauth2callback.do";
	   		  	redirectString="https://accounts.google.com/o/oauth2/auth?client_id="+"314873777255-7nbr179pmmdo76c8590t09vhplo9m6cr.apps.googleusercontent.com"+"&redirect_uri="+redirectUri+"&response_type=code&scope=https://www.googleapis.com/auth/analytics.readonly&access_type=offline&approval_prompt=force";
	   		  	System.out.println("redirect URI::::"+redirectString);
	   		 	res.sendRedirect(redirectString);
