    	...
    	try {
    		...
    		{System.out.println("checkign json Structure");
		    		...
		    		{System.out.println("refresh Toekn found");
		    			...
		    			String url="https://www.googleapis.com/upload/storage/v1/b/gadataservice-new-s.appspot.com/o?uploadType=media&name=GAData";
		    		...
		    		{
		   		  redirectString="https://accounts.google.com/o/oauth2/auth?client_id="+"314873777255-7nbr179pmmdo76c8590t09vhplo9m6cr.apps.googleusercontent.com"+"&redirect_uri="+REDIRECT_URL+"&response_type=code&scope="+SCOPE+"&access_type=offline&approval_prompt=force";
