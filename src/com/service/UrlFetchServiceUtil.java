...
public class UrlFetchServiceUtil {
	...
	public static String httpRequest(String urlString, String params, String methodName, String contentType, HashMap<String,String> header){
		...
		try{
			System.out.println("Inside UrlFetchServiceUtil::");
			...
			System.out.println("connection::after adding HttpURLConnection:"+connection);
			...
			if(connection.getResponseCode() == HttpURLConnection.HTTP_OK){
				BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream()));
                 System.out.println("Sucees::Server returned OK::");
			...
			System.out.println(e.getMessage());
                ...
                System.out.println("Checking responseJson::"+responseJson);
