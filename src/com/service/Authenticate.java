...
public class Authenticate
	...
	final static String APPLICATION_NAME="gadataservice-new-s";
    ...
    final static HttpTransport HTTP_TRANSPORT = new NetHttpTransport();
		...
		public void gaQurey(GoogleTokenResponse response,String accessToken,String dateFrom,String dateTo,boolean flag,ArrayList<GaData> list,String dimensions, String tableId, String filter, String month)
		{
			...
			int k=0,z=9999,max=9999;
				...
				System.out.println(dimensions);
					...
					{
						apiQuery.setFilters("ga:eventAction=@Transfer,ga:eventAction==Dialing,ga:eventCategory=@N/A");
						System.out.println("checking after removing Account load eventToTalk..::");
					}
					...
					if(gaData!=null && counter==1)
					{
						...
						Gson checkinggson = new Gson();
						String mychecking = checkinggson.toJson(gaDataKeyMap);
						System.out.println("Checking in Authenticate:::"+mychecking);
						System.out.println("****Checking****");*/
		...
		public String  updateAccessTokenWithResfreshToken(String refreshToken) {		
			...
			try{
		        ...
		        System.out.println("refresh_token::before adding to payload::"+refreshToken);
				String payload ="client_id="+CLIENT_ID+"&client_secret="+CLIENT_SECRET+"&refresh_token="+refreshToken+"&grant_type=refresh_token";
                 System.out.println("payload in updateAccessTokenWithRefreshToken::"+payload);
